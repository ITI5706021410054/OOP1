...
over=sum-100;  	
	...
	if (a1!=0)System.out.println("number 1.  "+a1); 
	if (a2!=0)	System.out.println("number 2.  "+a2); 	
	if (a3!=0)System.out.println("number 3.  "+a3); 	
	if (a4!=0)	System.out.println("number 4.  "+a4); 	
	if (a5!=0)System.out.println("number 5.  "+a5); 	
	if (a6!=0)System.out.println("number 6.  "+a6); 	
	if (a7!=0)System.out.println("number 7.  "+a7); 
	if (a8!=0)System.out.println("number 8.  "+a8); 	
	if (a9!=0)System.out.println("number 9.  "+a9); 		 		 
} 	 
}
